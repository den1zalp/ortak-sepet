...
const LISTINGS = [
  {
    name: "Zippo TR",
    home: "https://www.zippo.com.tr/",
    pattern: /zippo\.com\.tr\/urun\/\d+/i,
    site: "Zippo",
    priceRe: /^[\d.]+(,\d{2})? TL$/,
    imageRe: /zippo\.com\.tr\/images\/products/,
  },
  {
    name: "Zippo UK",
    home: "https://www.zippo.co.uk/",
    pattern: /zippo\.co\.uk\/products\//i,
    site: "Zippo UK",
    priceRe: /^£[\d,]+(\.\d{2})?$/,
    imageRe: /zippo\.co\.uk\/cdn\/shop/,
  },
];
