...
const I18N = {
  tr: {
    ...
    price: "Fiyat",
    size: "Beden",
    sizePlaceholder: "Beden seç",
    optionColour: "Renk",
    optionLength: "Uzunluk",
    optionStorage: "Depolama",
    optionPlaceholder: "{option} seç",
    optionLabel: "{title} için {option} seç",
    optionUpdated: "Seçim güncellendi.",
    optionMerged: "Aynı seçimden zaten vardı; adetler birleştirildi.",
    sizeUnknown: "Belirtilmedi",
    sizeLabel: "{title} için beden seç",
    editSize: "Beden Gir",
    editSizeLabel: "{title} için beden gir",
    promptNewSize: "Beden yazın:",
    sizeUpdated: "Beden güncellendi.",
    sizeMerged: "Aynı bedenden zaten vardı; adetler birleştirildi.",
    source: "Kaynak",
    manual: "Manuel",
    previous: "Önceki",
    installment: "Taksit",
    ...
    installmentUnavailableGroup: "Taksit / Finance Yok",
  ...
  en: {
    ...
    optionLabel: "Select {option} for {title}",
    optionUpdated: "Selection updated.",
    optionMerged: "That selection was already in the cart; quantities were merged.",
    sizeUnknown: "Not set",
    sizeLabel: "Select size for {title}",
    editSize: "Enter Size",
    editSizeLabel: "Enter size for {title}",
    promptNewSize: "Enter a size:",
    sizeUpdated: "Size updated.",
    sizeMerged: "That size was already in the cart; quantities were merged.",
    source: "Source",
    manual: "Manual",
    previous: "Previous",
    ...
    installmentUnavailableGroup: "No Instalments / Finance",
